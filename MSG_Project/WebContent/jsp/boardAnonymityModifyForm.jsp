	...
	<header id="main_header" style="height:82px">
		...
		<div id="content">
			...
			<div id="menuBox2">
				...
				<p style="margin: 20px">
					<a href="#" style="font-size: 20px; display: inline-block; text-decoration: none;">익명 게시판</a>
				</p>
				<hr id="hr3">
					<b style="font-size: 18px">게시글 수정</b>
					
					<div id="writeBox">
					
						<form action="boardAnonymityModify" method="post" enctype="multipart/form-data">
						
							<input type="hidden" name="boardNo" value="${anonymity.boardNo}">
							...
							<table id="writeTable">
								...
								<tr id="wTtr1">
									...
									<td style="border-bottom: 0.7px solid silver; text-align: left">
										<input type="text" placeholder="제목을 입력하세요." value="${anonymity.title}" name="TITLE" style="width:100%">
									</td>
								</tr>
								...
								<tr id="wTtr2">
									...
									<td style="border-bottom: 0.7px solid silver; text-align: left">
										<input type="text" placeholder="작성자 이름을 입력하세요." name="EMPNAME" readonly="readonly" value="${anonymity.writer}" style="width: 200px;">
									</td>
								</tr>
								...
								<tr id="wTtr3">
									...
									<td style="border-bottom: 0.7px solid silver; text-align: left;">
										<textarea name="CONTENT" class="summernote">${min.content}</textarea>
									</td>
								</tr>
								<tr id="wTtr4">
								...
								<tr>
									<th colspan="3" style="text-align: center;">
										...
										<button id="resetBtn" onclick="location.href='boardAnonymityViewForm?boardNo=${anonymity.boardNo}'" type="button">취소</button>
									</th>
								</tr>
