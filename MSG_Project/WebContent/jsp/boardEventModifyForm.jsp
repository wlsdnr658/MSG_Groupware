	...
	<header id="main_header" style="height:82px">
		...
		<div id="content">
			...
			<div id="menuBox2">
				...
				<p style="margin: 20px">
					<a href="${contextPath}/board/boardNotice" style="font-size: 20px; display: inline-block; text-decoration: none;">EVENT</a>
				</p>
				<hr id="hr3">
					...
					<div id="writeBox">
						...
						<form action="boardEventModify" method="post" enctype="multipart/form-data">
						
							<input type="hidden" name="boardNo" value="${event.boardNo}">
							...
							<table id="writeTable">
								...
								<tr id="wTtr1">
									...
									<td style="border-bottom: 0.7px solid silver; text-align: left">
										<input type="text" placeholder="제목을 입력하세요." value="${event.title}" name="TITLE" style="width:100%">
									</td>
								</tr>
								...
								<tr id="wTtr2">
									...
									<td style="border-bottom: 0.7px solid silver; text-align: left">
										<input type="text" placeholder="작성자 이름을 입력하세요." name="EMPNAME" readonly="readonly" value="${event.empName}" style="width: 200px;">
									</td>
								</tr>
								...
								<tr>
									<th colspan="3" style="text-align: center;">
										...
										<button id="resetBtn" type="button" onclick="location.href='boardEventViewForm?boardNo${event.boardNo}'">취소</button>
									</th>
								</tr>
