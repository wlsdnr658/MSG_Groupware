	...
	<header id="main_header" style="height:82px">
		...
		<div id="content">
			...
			<div id="menuBox2">
				...
				<p style="margin: 20px">
					<b style="font-size: 20px; display: inline-block; text-decoration: none;">IT부서 게시글 작성</b>
				</p>
				<hr id="hr3" style="margin-bottom: 10px;">
					<span><b style="font-size: 18px;cursor: pointer;" onclick="location.href='boardDeptIt'">IT부서 게시판</b></span><br>
					
					<div id="writeBox">
					
						<form name="frm" action="boardDeptItWrite" method="post" enctype="multipart/form-data" onsubmit="return checkTag();">
								<table id="writeTable">
								...
								<tr>
									<th colspan="5" style="text-align: center;">
										...
										<input id="resetBtn" type="button" value="취소" onclick="location.href='boardDeptIt'">
									</th>
								</tr>
