	...
	<header id="main_header" style="height:82px">
		...
		<div id="content">
			...
			<div id="menuBox2">
				...
				<p style="margin: 20px">
					<b style="font-size: 20px; display: inline-block; text-decoration: none;">이벤트 작성</b>
				</p>
				<hr id="hr3">
					<b onclick="location.href='boardEvent'" style="font-size: 18px;cursor: pointer;">이벤트</b>
					
					<div id="writeBox">
						<form name="frm" action="boardEventWrite" id="writeForm" enctype="multipart/form-data" method="post" onsubmit="return checkTag();">
							<table id="writeTable">
								...
								<tr>
									<th colspan="5" style="text-align: center;">
										...
										<input id="resetBtn" type="button" value="취소" onclick="location.href='boardEvent'">
<!-- 										<input id="listBtn" type="button" value="목록" onclick="location.href='boardEvent'">  -->
