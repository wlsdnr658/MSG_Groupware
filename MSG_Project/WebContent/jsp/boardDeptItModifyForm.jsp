	...
	<header id="main_header" style="height:82px">
		...
		<div id="content">
			...
			<div id="menuBox2">
				...
				<p style="margin: 20px">
					<a href="#" style="font-size: 20px; display: inline-block; text-decoration: none;">IT부서 게시판</a>
				</p>
				...
				<hr id="hr3" style="margin-bottom: 10px;">
					<span><b style="font-size: 18px;">게시글 수정</b></span><br>
						...
						<form action="boardDeptItModify" method="post" enctype="multipart/form-data">
						
							<input type="hidden" name="boardNo" value="${it.boardNo}">
							...
							<table id="writeTable">
								...
								<tr id="wTtr1">
									...
									<td style="border-bottom: 0.7px solid silver; text-align: left">
										<input type="text" placeholder="제목을 입력하세요." value="${it.title}" name="TITLE" style="width:100%">
									</td>
								</tr>
								...
								<tr id="wTtr2">
									...
									<td style="border-bottom: 0.7px solid silver; text-align: left">
										<input type="text" placeholder="작성자 이름을 입력하세요." name="EMPNAME" readonly="readonly" value="${it.empName}" style="width: 200px;">
									</td>
								</tr>
								...
								<tr id="wTtr3">
									...
									<td style="border-bottom: 0.7px solid silver; text-align: left;">
										<textarea name="CONTENT" class="summernote">${it.content}</textarea>
									</td>
								</tr>
								<tr id="wTtr4">
								...
								<tr>
									<th colspan="3" style="text-align: center;">
										...
										<button id="resetBtn" onclick="location.href='boardDeptItViewForm?boardNo=${it.boardNo}'" type="button">취소</button>
