...
<link rel = "stylesheet" type = "text/css" href = "${contextPath}/css/compleDocList.css">
...
<body>
	...
	<div id="content">
		...
		<div id="menuBox2">
			<p style="margin: 20px">
				<a href="#" style="font-size: 20px;">나의 완료 결재</a>
			</p>
			<hr id="hr3">
		</div>
		<div id = "apList">
				...
				<c:forEach var = "app" items="${viewData.appList}">
					<li class = "approv">
						<ul>
							...
							<span class = "writer" style = "float : left;">완료</span>
							<br>
								<span class = "title" style = "float : left;">
									<span style = "font-size: 12px;">${app.docName}</span>
									<a href = "javascript:detailView();" style = "margin-left : 10px;">${app.title}</a>
								</span>&nbsp;&nbsp;
