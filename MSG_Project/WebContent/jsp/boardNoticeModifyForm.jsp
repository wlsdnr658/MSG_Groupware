	...
	<header id="main_header" style="height:82px">
		...
		<div id="content">
			...
			<div id="menuBox2">
				...
				<p style="margin: 20px">
					<a href="${contextPath}/board/boardNotice" style="font-size: 20px; display: inline-block; text-decoration: none;">전체공지</a>
				</p>
				<hr id="hr3">
					...
					<div id="writeBox">
						...
						<form action="boardNoticeModify" method="post" enctype="multipart/form-data">
							...
							<table id="writeTable">
								...
								<tr id="wTtr1">
									...
									<td style="border-bottom: 0.7px solid silver; text-align: left">
										<input type="text" placeholder="제목을 입력하세요." value="${notice.title}" name="TITLE" style="width:100%">
									</td>
								</tr>
								...
								<tr id="wTtr2">
									...
									<td style="border-bottom: 0.7px solid silver; text-align: left">
										<input type="text" placeholder="작성자 이름을 입력하세요." name="EMPNAME" readonly="readonly" value="${notice.empName}" style="width: 200px;">
									</td>
								</tr>
								...
								<tr>
									<th colspan="3" style="text-align: center;">
										...
										<button id="resetBtn" onclick="location.href='boardNoticeViewForm?boardNo=${notice.boardNo}'" type="button">취소</button>
									</th>
								</tr>
