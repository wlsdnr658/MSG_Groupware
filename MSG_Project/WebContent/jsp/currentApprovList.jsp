...
<link rel = "stylesheet" type = "text/css" href = "${contextPath}/css/curDocList.css?ver3">
...
<body>
	...
	<div id="content">
		...
		<div id="menuBox2">
			<p style="margin: 20px">
				<a href="#" style="font-size: 20px;">나의 진행 결재</a>
			</p>
			<hr id="hr3">
		...
		<div id = "apList">
			<div style = "text-align: right; margin-bottom : 10px;">
				<form action="${contextPath}/approval/curDocForm">
